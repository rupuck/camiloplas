...
<html>
	<head>
		...
		<title>Camiloplas | Manufacturing</title>	

		<meta name="keywords" content="HTML5 Template" />
		<meta name="description" content="Camiloplas - Manufacturing">
	...
	<body>
		<div class="body">
            ...
            <footer id="footer" class="section section-with-shape-divider border-0 pt-5 pb-0 m-0" style=" background-color: #2e3192;">
				<div class="shape-divider shape-divider-reverse-x" style="height: 120px;">
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 2000 120" preserveAspectRatio="xMinYMin">
						<polygon fill="#2e3192" points="-11,2 693,112 2019,6 2019,135 -11,135 "/>
					</svg>
				</div>
				<div class="container pt-lg-5 mt-5" >
					<div class="row">
						...
						<div class="col-lg-4 offset-lg-1 mb-5 mb-lg-0">
							<h4 class="text-color-light font-weght-bold positive-ls-2 custom-font-size-2">SITEMAPS</h4>
							<div class="row">
								<div class="col-md-6">
				...
				<div class="footer-copyright mt-5 pb-5" style="background-color:#f2e600">
					<div class="container custom-footer-top-light-border pt-4">
						<div class="row">
							<div class="col">
								<p class="text-center text-3 mb-0" style="color:black">PT. Camiloplas Jaya Makmur © 2021. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
